...
from advanced_practitioner_tools import advanced_practitioner_tools
from safety_quality_assurance import safety_quality_assurance
...
async def get_protocol_structured_data(protocol_id: str):
    ...
    try:
        ...
        structured_data = {
            ...
            "url": f"https://peptide-wizard-3.preview.emergentagent.com/protocol/{protocol['id']}",
